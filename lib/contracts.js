...
- "signed" = obligations that activate right after signing but before the contract becomes fully active: setup tasks, onboarding, initial filings, system integrations, first-time registrations, opening accounts, initial deposits.
...
- CATEGORY RULES: Use exactly 4 categories:
  - "payments" = all payment obligations (fees, invoices, deposits, refunds)
  - "termination" = termination notices, renewal opt-outs, exit procedures
  - "legal" = compliance, confidentiality, insurance, indemnification, reporting, regulatory
  - "others" = delivery, operational, anything that doesn't fit above
