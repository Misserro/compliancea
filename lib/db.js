  ...
  const templates = [
    {
      ...
      template_body: `<h1>WEZWANIE DO ZAPŁATY</h1>
...
<p><strong>Załączniki:</strong><br>[UZUPEŁNIJ: lista załączników, np. kopia faktury, kopia umowy, kopia pełnomocnictwa]</p>`,
    },
    {
      ...
      document_type: "pozew",
      template_body: `<p><strong>[UZUPEŁNIJ: miejscowość]</strong>, dnia {{today}}</p>
 ...
 * @returns {Object[]}
 */
export function getLegalCases({ search, status, caseType } = {}) {
  let sql = `
    SELECT lc.*,
 ...
 * @returns {Object[]}
 */
export function getCaseTemplates({ search, documentType, isActive } = {}) {
