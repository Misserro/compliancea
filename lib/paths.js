...
export const INVOICES_DIR = path.join(DOCUMENTS_DIR, "invoices");
export const CONTRACT_ATTACHMENTS_DIR = path.join(DOCUMENTS_DIR, "contract-attachments");
export const CASE_ATTACHMENTS_DIR = path.join(DOCUMENTS_DIR, "case-attachments");
...
export function ensureDirectories() {
  ...
  if (!fs.existsSync(CASE_ATTACHMENTS_DIR)) {
    fs.mkdirSync(CASE_ATTACHMENTS_DIR, { recursive: true });
  }
